...
>>>>>>> 5d13aacd343883b2c7ace01db7280a0664c0a6e4
    ...
    "Repair mailbox" : "Repara la bústia",
    ...
    "Could not copy to \"Sent\" mailbox" : "No s'ha pogut copiar a la bústia de correu \"Enviat\"",
    ...
    "Copy to \"Sent\" Mailbox" : "Copia a la bústia de correu \"Enviat\"",
    "Copy to Sent Mailbox" : "Copia a la bústia Enviat",
...
=======
    ...
    "Flag" : "Bandera",
    "The stop action ends all processing" : "L'acció d'aturar finalitza tot el processament",
    ...
    "Update mail filter" : "Actualitza el filtre de correu",
    "Filter name" : "Nom del filtre",
    "Tests are applied to incoming emails on your mail server, targeting fields such as subject (the email's subject line), from (the sender), and to (the recipient). You can use the following operators to define conditions for these fields:" : "Les proves s'apliquen als correus electrònics entrants al vostre servidor de correu, orientant camps com ara l'assumpte (l'assumpte del correu electrònic), de (el remitent) i a (el destinatari). Podeu utilitzar els operadors següents per definir les condicions d'aquests camps:",
    "An exact match. The field must be identical to the provided value." : "Una coincidència exacta. El camp ha de ser idèntic al valor proporcionat.",
    ...
    "Actions are triggered when the specified tests are true. The following actions are available:" : "Les accions es desencadenen quan les proves especificades són certes. Les accions següents estan disponibles:",
    "Moves the message into a specified folder." : "Mou el missatge a una carpeta especificada.",
    "Adds a flag to the message." : "Afegeix una bandera al missatge.",
    "Halts the execution of the filter script. No further filters with will be processed after this action." : "Atura l'execució de l'script de filtre. No es processaran més filtres amb després d'aquesta acció.",
    "Priority" : "Prioritat",
    "Enable filter" : "Habilitar el filtre",
    "Save filter" : "Desar el filtre",
...
>>>>>>> 5d13aacd343883b2c7ace01db7280a0664c0a6e4
    ...
    "Message copied to \"Sent\" mailbox" : "S'ha copiat el missatge a la bústia de correu \"Enviat\"",
    "Could not copy message to \"Sent\" mailbox" : "No s'ha pogut copiar el missatge a la bústia de correu \"Enviat\"",
...
=======
    "Draft: " : "Esborrany: ",
    "If all tests pass, then the actions will be executed" : "Si passen totes les proves, s'executaran les accions",
    "If one test pass, then the actions will be executed" : "Si una prova passa, les accions s'executaran",
    "Tests" : "Proves",
    "New test" : "Nova prova",
    "Actions" : "Accions",
