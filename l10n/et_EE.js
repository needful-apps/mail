OC.L10N.register(
    ...
    "Reply-To email: %1$s  is different from the sender email: %2$s" : "Vastamiseks mõeldud e-posti aadress %1$s on erinev saatja aadressist %2$s",
    ...
    "Mailbox search" : "Postkasti otsing",
    ...
    "Cancel" : "Katkesta",
    "Search in the body of messages in priority Inbox" : "Otsi esmase postkasti kirjade sisust",
    ...
    "Use internal addresses" : "Kasuta sisemisi aadresse",
    ...
    "Allow the app to collect data about your interactions. Based on this data, the app will adapt to your preferences. The data will only be stored locally." : "Luba rakendusel koguda andmeid sinu kasutusharjumuste kohta. Nende andmete alusel rakendus kohendab oma seadistusi. Kogutud andmed on säilitatud vaid kohalikus serveris.",
    "Trusted senders" : "Usaldatud saatjad",
    "Internal addresses" : "Sisemised aadressid",
    "Highlight external email addresses by enabling this feature, manage your internal addresses and domains to ensure recognized contacts stay unmarked." : "Selle valikuga tõstetakse välised e-posti aadressid esile, hallatakse sinu jaoks serveri sisemisi aadresse ja domeene. Nii tagatakse, et sinu poolt kinnitatud kontaktid jäävad esiletõstmata.",
    "S/MIME" : "S/MIME",
    ...
    "No trash mailbox configured" : "Prügikasti kaust on määramata",
    ...
    "To archive a message please configure an archive mailbox in account settings" : "Kui tahad kirju arhiveerida, pead esmalt seadistustest valima arhiivikausta",
    ...
    "Could not open mailbox" : "Postkasti avamine ei õnnestunud",
    "Loading messages …" : "Laadin kirju…",
    "Indexing your messages. This can take a bit longer for larger mailboxes." : "Indekseering sinu kirju. Kui postkastid on väga suured, siis võib kuluda natuke aega.",
    "Choose target mailbox" : "Vali sihtpostkast",
    ...
    "Loading …" : "Laadin...",
    "Not supported by the server" : "See pole serveri poolt toetatud",
    "{usage} of {limit} used" : "Kasutusel: {usage} / {limit} ",
    ...
    "Quota" : "Kvoot",
    "Show only subscribed mailboxes" : "Näita vaid tellitud postkaste",
    "Add mailbox" : "Lisa postkast",
    "Mailbox name" : "Postkasti nimi",
    "Saving" : "Salvestan",
    "Move up" : "Liiguta ülespoole",
    "Move down" : "Liiguta allapoole",
    "Show all subscribed mailboxes" : "Näita kõiki tellitud postkaste",
    "Show all mailboxes" : "Näita kõiki postkaste",
    "Collapse mailboxes" : "Ahenda postkastid",
    ...
    "Clear mailbox" : "Tühjenda postkast",
    "The mailbox and all messages in it will be deleted." : "Postkast ja kõik temas leiduvad kirjad saavad järgnevaga kustutatud.",
    "Delete mailbox" : "Kustuta postkast",
    "Delete mailbox {name}" : "Kustuta postkast: {name}",
    ...
    "Could not copy to \"Sent\" mailbox" : "Kirja on kopeerimine „Saadetud“ postkasti ei õnnestunud",
    ...
    "Copy to \"Sent\" Mailbox" : "Kopeeri „Saadetud“ kirjade postkasti",
    "Copy to Sent Mailbox" : "Kopeeri „Saadetud“ kirjade postkasti",
...
=======
    ...
    "If all the conditions are met" : "Kui kõik tingimused on täidetud",
    "If any of the conditions are met" : "Kui mõni tingimutest on täidetud",
    "Add condition" : "Lisa tingimus",
    "Then perform these actions" : "Seejärel käivita need tegevused",
    "Actions are triggered when the specified tests are true. The following actions are available:" : "Tegevused käivituvad, kui konkreetse testi vastus on tõene. Saadaval on järgnevad tegevused:",
    "Moves the message into a specified folder." : "Teisaldab kirja etteantud kausta.",
    "Adds a flag to the message." : "Lisab kirjale märgistuse.",
    "Halts the execution of the filter script. No further filters with will be processed after this action." : "Lõpetab Sieve skripti töö. Peale seda ei töödelda ühtegi järgnevat tingimust.",
