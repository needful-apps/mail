...
>>>>>>> 5d13aacd343883b2c7ace01db7280a0664c0a6e4
    ...
    "Add tag" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
...
=======
    ...
    "Choose the headers you want to use to create your filter. In the next step, you will be able to refine the filter conditions and specify the actions to be taken on messages that match your criteria." : "Wähle die Header aus, mit denen du deine Filter erstellen möchtest Im nächsten Schritt können dann die Filterbedingungen verfeinert und die Aktionen festgelegt werden, die auf Nachrichten angewandt werden sollen, auf die die deine Kriterien zutreffen.",
    ...
    "Then perform these actions" : "Dann diese Aktionen ausführen",
