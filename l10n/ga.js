...
>>>>>>> 5d13aacd343883b2c7ace01db7280a0664c0a6e4
    ...
    "Use internal addresses" : "Úsáid seoltaí inmheánacha",
    ...
    "Newest" : "is nuaí",
    "Oldest" : "Is sine",
    "Search in body" : "Cuardach i gcorp",
    ...
    "Register" : "Clár",
    "Privacy and security" : "Príobháideacht agus slándáil",
...
=======
    ...
    "Flag" : "Brat",
    "The stop action ends all processing" : "Críochnaíonn an gníomh stad gach próiseáil",
    "Sender" : "Seoltóir",
    ...
    "contains" : "ina bhfuil",
    "matches" : "oireann",
    "Delete test" : "Scrios tástáil",
    "Update mail filter" : "Nuashonraigh an scagaire ríomhphoist",
    "Filter name" : "Ainm an scagaire",
    "If all the conditions are met" : "Má chomhlíontar na coinníollacha go léir",
    "If any of the conditions are met" : "Má chomhlíontar aon cheann de na coinníollacha",
    "Tests are applied to incoming emails on your mail server, targeting fields such as subject (the email's subject line), from (the sender), and to (the recipient). You can use the following operators to define conditions for these fields:" : "Cuirtear tástálacha i bhfeidhm ar ríomhphoist a thagann isteach ar do fhreastalaí ríomhphoist, ag díriú ar réimsí mar ábhar (líne ábhair an ríomhphoist), ó (an seoltóir), agus chuig (an faighteoir). Is féidir leat na hoibreoirí seo a leanas a úsáid chun coinníollacha a shainiú do na réimsí seo:",
    "An exact match. The field must be identical to the provided value." : "Cluiche cruinn. Caithfidh an réimse a bheith comhionann leis an luach a sholáthraítear.",
    ...
    "Then perform these actions" : "Ansin déan na gníomhartha seo",
    "Actions are triggered when the specified tests are true. The following actions are available:" : "Spreagtar gníomhartha nuair a bhíonn na tástálacha sonraithe fíor. Tá na gníomhartha seo a leanas ar fáil:",
    "Moves the message into a specified folder." : "Bogtar an teachtaireacht isteach i bhfillteán sonraithe.",
    "Adds a flag to the message." : "Cuireann sé bratach leis an teachtaireacht.",
    "Halts the execution of the filter script. No further filters with will be processed after this action." : "Cuireann sé stad le feidhmiú na scripte scagaire. Ní dhéanfar aon scagairí eile a phróiseáil tar éis an ghnímh seo.",
...
=======
    "Draft: " : "Dréacht:",
    "If all tests pass, then the actions will be executed" : "Má éiríonn le gach tástáil, déanfar na gníomhartha a fhorghníomhú",
    "If one test pass, then the actions will be executed" : "Má tá pas amháin tástála, ansin beidh na gníomhartha a fhorghníomhú",
    "Tests" : "Tástálacha",
    "New test" : "Tástáil nua",
    "Actions" : "Gníomhartha",
