...
=======
    ...
    "Delete action" : "刪除操作",
    "Flag" : "旗",
    "The stop action ends all processing" : "停止操作將會結束所有處理",
    "Sender" : "寄件人",
    "Recipient" : "收件人",
    ...
    "If any of the conditions are met" : "如果所有條件均符合",
    ...
    "Then perform these actions" : "將執行這些相應操作",
...
=======
    "Draft: " : "草稿：",
    "If all tests pass, then the actions will be executed" : "如果所有測試都通過，則將執行相應的操作",
    "If one test pass, then the actions will be executed" : "如果通過一個測試，則將執行相應的操作",
    "Tests" : "測試",
    "New test" : "新測試",
    "Actions" : "操作",
    "New action" : "新操作"
