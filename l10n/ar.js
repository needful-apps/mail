...
<<<<<<< HEAD
    "Please connect to a sieve server first." : "رجاءً، إتّصل بخادم تصفية أوّلاً.",
...
>>>>>>> 5d13aacd343883b2c7ace01db7280a0664c0a6e4
    ...
    "Highlight external email addresses by enabling this feature, manage your internal addresses and domains to ensure recognized contacts stay unmarked." : "قم بتمييز عناوين البريد الإلكتروني الخارجية من خلال تمكين هذه الخاصِّية، وإدارة عناوينك ونطاقاتك الداخلية لضمان بقاء جهات الاتصال المعروفة دون علامات تمييز عليها.",
    "S/MIME" : "S/MIME",
...
=======
    ...
    "Flag" : "علَم",
    "The stop action ends all processing" : "إجراء الإيقاف ينهي جميع المعالجات",
    "Recipient" : "المتلقي",
    ...
    "Actions are triggered when the specified tests are true. The following actions are available:" : "يتم إطلاق الإجراءات عندما تكون الاختبارات المحددة صحيحة. الإجراءات التالية متاحة:",
    "Moves the message into a specified folder." : "تَنقُل الرسالة إلى مجلد محدد.",
    "Adds a flag to the message." : "تَضَع علامة على الرسالة",
    "Halts the execution of the filter script. No further filters with will be processed after this action." : "يُوقف تنفيذ سكريبت الفلتر. لن تتم معالجة أي فلاتر أخرى بعد هذا الإجراء.",
    "Priority" : "الأولوية",
...
=======
    "Draft: " : "المُسوَّدة:",
    "If all tests pass, then the actions will be executed" : "عند اجتياز كل الاختبارات، سيتم تنفيذ الإجراءات",
    "If one test pass, then the actions will be executed" : "إذا تمّ اجتياز اختبار واحد، سيتم تنفيذ الإجراءات",
    "Tests" : "الاختبارات",
    "New test" : "إختبار جديد",
    "Actions" : "الإجراءات",
