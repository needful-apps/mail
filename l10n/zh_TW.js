OC.L10N.register(
    ...
    "Reply-To email: %1$s  is different from the sender email: %2$s" : "「回覆至」的電子郵件：%1$s 與寄件者的電子郵件：%2$s 不同",
...
>>>>>>> 5d13aacd343883b2c7ace01db7280a0664c0a6e4
    ...
    "Highlight external email addresses by enabling this feature, manage your internal addresses and domains to ensure recognized contacts stay unmarked." : "透過啟用此功能來突顯外部電子郵件地址，管理您的內部地址與網域以確保已識別的聯絡人不受標記。",
    "S/MIME" : "S/MIME",
...
=======
    ...
    "Delete action" : "刪除動作",
    "Flag" : "旗標",
    "The stop action ends all processing" : "停止動作將會結束所有處理",
    "Sender" : "寄件者",
    "Recipient" : "收件人",
    ...
    "matches" : "符合",
    "Delete test" : "刪除測試",
    "Update mail filter" : "更新郵件篩選器",
    "Filter name" : "篩選器名稱",
    "If all the conditions are met" : "若滿足所有條件",
    "If any of the conditions are met" : "若滿足任何條件",
    "Tests are applied to incoming emails on your mail server, targeting fields such as subject (the email's subject line), from (the sender), and to (the recipient). You can use the following operators to define conditions for these fields:" : "測試會套用至您郵件伺服器上的寄入電子郵件，目標欄位包含主旨（電子郵件的主旨行）、寄件人與收件人。您可以使用下列運算子為這些欄位定義條件：",
    "An exact match. The field must be identical to the provided value." : "完全符合。欄位必須與提供的值相符。",
    ...
    "Add condition" : "新增條件",
    "Then perform these actions" : "然後執行這些動作",
    "Actions are triggered when the specified tests are true. The following actions are available:" : "當指定的測試為真時，會觸發動作。有下列動作：",
    "Moves the message into a specified folder." : "將訊息移動到指定的資料夾。",
    "Adds a flag to the message." : "新增旗標至訊息。",
    "Halts the execution of the filter script. No further filters with will be processed after this action." : "停止執行篩選器命令稿。執行此動作後將不再處理其他篩選器。",
    "Add action" : "新增動作",
    "Priority" : "優先",
    "Enable filter" : "啟用篩選器",
    "Save filter" : "儲存篩選器",
...
=======
    "Draft: " : "草稿：",
    "If all tests pass, then the actions will be executed" : "若所有測試都通過，則會執行動作",
    "If one test pass, then the actions will be executed" : "若通過一個測試，則會執行動作",
    "Tests" : "測試",
    "New test" : "新測試",
    "Actions" : "動作",
    "New action" : "新動作"
