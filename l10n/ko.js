...
>>>>>>> 5d13aacd343883b2c7ace01db7280a0664c0a6e4
    ...
    "Install Mailvelope browser extension by clicking here" : "여기를 눌러 Mailvelope 브라우저 확장기능을 설치하십시오",
    ...
    "Plain text" : "평문",
    "Rich text" : "서식 있는 텍스트",
    "No messages in this mailbox" : "이 편지함에 메시지가 없음",
    "No messages" : "메시지가 없음",
    "No subject" : "제목 없음",
    ...
    "No trash mailbox configured" : "휴지통 편지함이 설정되지 않음",
    ...
    "Remove" : "삭제",
    "email" : "이메일",
    "To archive a message please configure an archive mailbox in account settings" : "메일을 보관하기 위해서는 계정 설정에서 보관 편지함을 설정하십시오",
    ...
    "Could not open mailbox" : "편지함을 열 수 없음",
    "Loading messages …" : "메시지를 불러오는 중 ...",
    "Indexing your messages. This can take a bit longer for larger mailboxes." : "메시지를 색인 중입니다. 편지함이 클 경우 오래 걸릴 수 있습니다.",
    "Choose target mailbox" : "대상 편지함 선택",
    ...
    "Always show images from {domain}" : "{domail}(으)로부터 발신된 이미지를 항상 보기",
    "Quoted text" : "인용된 문구",
    "Move" : "이동",
    "Moving" : "이동 중",
    ...
    "Quota" : "할당량",
    "Show only subscribed mailboxes" : "구독 중인 편지함만 표시",
    "Add mailbox" : "편지함 추가",
    "Mailbox name" : "편지함 이름",
    "Saving" : "저장 중",
    "Move up" : "위로 이동",
    ...
    "Clear mailbox" : "편지함 비우기",
    "The mailbox and all messages in it will be deleted." : "편지함과 해당 편지함의 모든 메시지가 삭제됩니다",
    "Delete mailbox" : "편지함 삭제",
    "Delete mailbox {name}" : "편지함 {name} 비우기",
    ...
    "attachment" : "첨부파일",
    "attached" : "첨부됨",
    "No sent mailbox configured. Please pick one in the account settings." : "보낸 편지함이 설정되지 않았습니다. 계정 설정에서 지정하십시오.",
