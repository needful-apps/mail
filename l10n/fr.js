OC.L10N.register(
    ...
    "Slow mail service detected (%1$s) an attempt to connect to several accounts took an average of %2$s seconds per account" : "Un service de messagerie lent a été détecté (%1$s) ; une tentative de connexion à plusieurs comptes a pris en moyenne %2$s secondes par compte",
    "Slow mail service detected (%1$s) an attempt to perform a mail box list operation on several accounts took an average of %2$s seconds per account" : "Un service de messagerie lent a été détecté (%1$s) ; une tentative d'exécution d'une opération de liste de boîte aux lettres sur plusieurs comptes a pris en moyenne %2$s secondes par compte",
...
>>>>>>> 5d13aacd343883b2c7ace01db7280a0664c0a6e4
    ...
    "Please wait for the message to load" : "Veuillez patienter que le message se charge",
...
=======
    ...
    "If all the conditions are met" : "Si toutes les conditions sont remplies",
    "If any of the conditions are met" : "Si l'une des conditions est remplie",
    ...
    "Then perform these actions" : "Alors réaliser ces actions",
